...
export default function PageHero({
  ...
  return (
    <section className="relative min-h-[55vh] lg:min-h-[60vh] w-full flex flex-col justify-end pb-14 md:pb-16 pt-32 bg-[#0c150b] select-none overflow-hidden">
      <Image
        src={image}
        alt=""
        fill
        ...
        >
          ...
          {crumbs.map((c) => (
            <span key={c.label} className="flex items-center gap-2">
              ...
              {c.href ? (
                <Link href={c.href} className="hover:text-[#dfd0bd] transition-colors">
                  {c.label}
                </Link>
              ) : (
