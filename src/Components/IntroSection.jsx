...
export default function SplitIntroSection() {
  return (
    ...
    >
      ...
      <div
        className="relative bg-cover bg-center flex items-center p-6 sm:p-12 lg:p-20 py-16 md:py-0 min-h-95 md:min-h-0"
        style={{
      ...
      {/* 
        ...
        - 'items-center md:items-start' lagaya hai taaki main layout alignment dynamic switch ho sake.
      */}
      <div className="bg-[#b5a78d] flex flex-col justify-center items-center p-6 sm:p-12 lg:p-20 py-16 md:py-0 text-[#fdfcf7] relative">
        <div className="max-w-xl w-full flex flex-col justify-center space-y-6 md:space-y-8 items-center md:items-start">
          {/* Upper Paragraph Info: Mobile par centered ('text-center'), desktop par left-aligned ('md:text-left') */}
          ...
          {/* Subheadings: Mobile par text-center aur desktop par md:text-left layout toggle */}
          <div
          ...
          {/* Bottom Call-to-Action Pill Button Container */}
